<template>
  ...
  <!--  </base-card>-->
  <base-card>
    <button @click="setSelected('stored-resources')" :mode="storedResButtonMode">Stored Resources</button>
    <button @click="setSelected('add-resource')" :mode="addResButtonMode">Add Resource</button>
    <keep-alive>
